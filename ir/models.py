...
class VSM:
    ...
    def get_scores_tf_idf_weighted(self, query, weight):
        ...
        scores_title  = { doc_id : cosine(query_vector_title , self.doc_tf_idf_vectors_title[doc_id])  for doc_id in tqdm(self.get_doc_ids()) }
